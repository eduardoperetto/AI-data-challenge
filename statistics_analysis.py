...
def main():
    ...
    df['Run'] = df.groupby(['Modelo', 'Consider RTT/TR?']).cumcount() + 1
    ...
    # Check if both 'Mean' and 'Std' exist for all groups
    ...
    summary['Number of Runs'] = summary['Number of Runs'] // 2
    ...
    if p < SIGNIFICANCE_LEVEL:
        ...
        combined_matrix = combined_matrix.replace("NaN (ns)", "")
